...
est store model_urban_DE
estadd local type "urban"
...
(urbanCI <- NUPPdid logurbangdp logurbancarbon logenvcost lnurbanpop lngovspend lnmedppl tech_ratio edu_ratio)       ///
...
gsem (shlta <- NUPPdid_male logurbangdp logurbancarbon urbanCI logenvcost urban_medbed_per raeducl age rahltcom hukou lngovspend lnurbanpop lnmedppl i.year), nocapslatent

est store model_male_ddd
estadd local type "urban_gender_ddd"



esttab model_male_ddd using $tbls/SEM_urban_ddd.csv, replace se label star(* 0.1 ** 0.05 *** 0.01)  stats(N aic bic type,fmt(%9.0f %9.0f %9.0f %9s)) keep(NUPPdid_male logenvcost logurbancarbon urbanCI logurbangdp urban_medbed_per)
